...
| **F3b** Via `scan_root` | rimozione di `scan_root`/`root_id`/`root_targets` e della pagina Sources (83 riferimenti) | i target del piano derivano da Settings, nessuna regressione su Piano e Apply |
