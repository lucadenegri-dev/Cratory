...
export const en = {
  ...
  settings: {
    sections: { general: "General", library: "Library", downloads: "Downloads", connections: "Connections", backup: "Backup" },
    setupHeading: "Initial setup",
    setupHint: "Reopen the guide to connect your services.",
    setupButton: "Open setup guide",
    retryButton: "Try again",
    namingHeading: "File and folder names",
    connectionsHint: "Accounts and services used by Cratory.",
    backupHint: "Save a copy of your Cratory data or restore a backup.",
    libraryHint: "Where you keep your music and how you organize files.",
    downloadsHint: "Download folder and Soulseek preferences.",
    downloadFolderHint: "Files appear in the Inbox section of Organize.",
    advancedSoulseek: "Advanced Soulseek settings",
    manageButton: "Manage",
    configureButton: "Configure",
    connectionGuide: "How to connect this service",
    modelHint: "Model used by Set Agent and AI suggestions.",
    organizationHint: "Choose how to name files and group them into folders.",
    automaticSave: "Saved",
    ...
    slskdStepConfigure: "Enter your Soulseek username and password to configure the connection.",
    slskdStepStart: "Soulseek is configured. Start the service to connect.",
    slskdStepConnect: "The service is running. Connect to the Soulseek network.",
    slskdStepRepair: "The access key is invalid. Repair the connection and restart the service.",
    slskdRepair: "Repair and restart",
    slskdRepairing: "Repairing…",
    slskdRepairNeedsRestart: "Connection repaired. Restart slskd to finish setup.",
    ...
    backupNote: "The backup includes service credentials. Keep the file somewhere safe.",
    ...
    servicesMeta: {
      spotify: {
        detail: "Import playlists and saved tracks.",
      },
      anthropic: {
        detail: "Enable Set Agent and AI suggestions in Organize.",
      },
      discogs: {
        detail: "Find records and complete track information.",
      },
      musicbrainz: {
        detail: "Find artists, titles and release information.",
      },
      acoustid: {
        detail: "Identify tracks from their audio.",
      },
      slskd: {
        detail: "Find and download music on the Soulseek network.",
      },
      soundcloud: {
        detail: "Import your likes and download tracks.",
      },
    } as Record<string, { detail: string }>,
    reconnectButton: "Reconnect",
    connectButton: "Connect",
    collapseKeys: "Close",
    fieldLibraryRoot: "Music folder",
    fieldArchiveRoot: "Archive folder",
    fieldDownloadsDir: "Download folder",
    fieldSlskdUrl: "slskd address",
    fieldSlskdConfig: "slskd configuration file",
    ...
    shareLibraryHint: "Other users will be able to see and download files from your library.",
    shareOnRescan: "Sharing is active. The list of shared files has been updated.",
    shareOnPending: "Preference saved. Sharing will start the next time slskd runs.",
    shareOff: "Sharing turned off.",
    downloadSlotsLabel: "Simultaneous downloads",
    downloadSlotsHint: "How many tracks to download at once, from 1 to 10.",
    downloadSlotsInvalid: "Invalid value (must be a number between 1 and 10): reverted to the current one.",
    soundcloudYtdlpUnavailable: "yt-dlp is missing. It is required for SoundCloud imports.",
    ...
    soulseekUnreachable: "The Soulseek service is unreachable",
    soulseekConnect: "Connect",
    soulseekDisconnect: "Disconnect",
    canonicalLibraryTitle: "Library scan",
    canonicalLibraryBody: "Update the track list after adding or moving files.",
    indexFailedFallback: "Scan failed",
    indexingLabel: "In progress…",
    indexNowButton: "Scan now",
    ...
    discoveryDiscogs: "Show Discogs in Discovery",
    discoveryDiscogsHint: "Adds Discogs to the available search sources.",
  },
  setup: {
    title: "Guided setup",
  ...
  sets: {
    ...
    emptyBody: "Use «Prepare a set» to start building one by hand.",
    legacyBadge: "old format",
    legacyHint: "Made by the old generator: you can only export or delete it.",
    algoBadge: "algo",
    ...
    manual: {
      ...
      redoButton: "Redo",
      groupButton: "Group",
      selectRowLabel: "Select the row",
      sequenceUnnamed: "unnamed",
      sequenceMeta: (n: number) => (n === 1 ? "1 track" : `${n} tracks`),
      renameSequenceTitle: "Rename the sequence",
      sequenceNamePlaceholder: "Sequence name",
      splitSequenceTitle: "Split the sequence",
      toBenchTitle: "Move to the bench",
      benchTitle: "Bench",
      benchEmpty: "Nothing on the bench. Group some rows and move them here to try them out of the path.",
      benchToPathTitle: "Put back in the path",
      moveSequenceUpTitle: "Move the sequence up",
      moveSequenceDownTitle: "Move the sequence down",
      playBpmLabel: "I play it at",
      playBpmHint: "Empty = at the track's own tempo.",
      transitionInTitle: "From the previous track",
      transitionOutTitle: "To the next track",
      ...
      durationIncompleteWhy: (rows: number, gaps: number) => [
        rows ? (rows === 1 ? "1 track with no duration" : `${rows} tracks with no duration`) : "",
        gaps ? (gaps === 1 ? "1 open gap" : `${gaps} open gaps`) : "",
      ].filter(Boolean).join(" · "),
      plannedSecondsLabel: "How long I keep it",
      plannedSecondsHint: "Empty = the file's own length.",
      exportButton: "Export",
      ...
      exportFormatPrep: "Preparation sheet",
      exportFormatReserve: "Reserve",
      fillGapTitle: "Fill the gap",
      fillGapCountLabel: "How many tracks",
      fillGapButton: "Fill",
  ...
  organize: {
    ...
    settings: {
      ...
      tplNameLabel: "File name",
      fieldsLabel: "Available fields:",
      tplFolderLabel: "Subfolders",
      subfoldersLabel: "subfolders:",
      noSubfolders: "Leave blank to keep files in the music folder.",
      pathPreview: "Example",
      previewHint: "The actual path depends on the track’s metadata.",
      saveTemplates: "Save rules",
      foldersNote: "These rules will be used in future Organize operations.",
    },
    files: {
      facetGenre: "genre…",
      facetArtist: "artist…",
  ...
  errors: {
    ...
    set_block_not_found: "Sequence not found",
    set_nothing_to_undo: "Nothing to undo",
    set_nothing_to_redo: "Nothing to redo",
    set_fill_failed: "The generator could not fill this gap",
    set_format_not_available: "This format belongs to a hand-prepared set",
