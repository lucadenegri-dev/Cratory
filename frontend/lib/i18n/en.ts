...
export const en = {
  ...
  settings: {
    ...
    pageTitle: "Settings",
    helpTitle: "Help",
    marginaliaPrefix: "Keys are set here and take effect immediately, with no backend restart.",
    marginaliaSuffix: "still provides the defaults.",
    ...
    slskdStepRepair: "The daemon answers but rejects Cratory's API key: its configuration predates the key Cratory now writes.",
    slskdRepair: "Repair and restart",
    slskdRepairing: "Repairing…",
    slskdRepairNeedsRestart: "Key written. Restart slskd so it picks it up: API keys are only loaded at startup.",
