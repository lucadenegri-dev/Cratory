...
export const it: Dictionary = {
  ...
  settings: {
    ...
    helpTitle: "Aiuto",
    marginaliaPrefix: "Le chiavi si impostano da qui e valgono subito, senza riavviare il backend.",
    marginaliaSuffix: "resta come sorgente dei valori predefiniti.",
    ...
    slskdStepRepair: "Il demone risponde ma rifiuta la chiave API di Cratory: la sua configurazione è più vecchia della chiave che Cratory scrive adesso.",
    slskdRepair: "Ripara e riavvia",
    slskdRepairing: "Riparazione…",
    slskdRepairNeedsRestart: "Chiave scritta. Riavvia slskd perché la legga: le chiavi API si caricano solo all'avvio.",
