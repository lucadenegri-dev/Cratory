...
export const it: Dictionary = {
  ...
  settings: {
    sections: { general: "Generali", library: "Libreria", downloads: "Download", connections: "Collegamenti", backup: "Backup" },
    setupHeading: "Configurazione iniziale",
    setupHint: "Riapri la procedura per collegare i servizi.",
    setupButton: "Apri la guida",
    retryButton: "Riprova",
    namingHeading: "Nomi dei file e delle cartelle",
    connectionsHint: "Account e servizi usati da Cratory.",
    backupHint: "Salva una copia dei dati di Cratory o ripristina un backup.",
    libraryHint: "Dove conservi la musica e come organizzi i file.",
    downloadsHint: "Cartella di arrivo e preferenze di Soulseek.",
    downloadFolderHint: "I file compaiono nella sezione Inbox di Organize.",
    advancedSoulseek: "Impostazioni avanzate di Soulseek",
    manageButton: "Gestisci",
    configureButton: "Configura",
    connectionGuide: "Come collegare il servizio",
    modelHint: "Modello usato da Set Agent e dai suggerimenti AI.",
    organizationHint: "Scegli come rinominare i file e dividerli in sottocartelle.",
    automaticSave: "Salvato",
    ...
    slskdStepConfigure: "Inserisci il nome utente e la password di Soulseek per configurare il collegamento.",
    slskdStepStart: "Soulseek è configurato. Avvia il servizio per collegarti.",
    slskdStepConnect: "Il servizio è in esecuzione. Collegati alla rete Soulseek.",
    slskdStepRepair: "La chiave di accesso non è valida. Ripara il collegamento e riavvia il servizio.",
    slskdRepair: "Ripara e riavvia",
    slskdRepairing: "Riparazione…",
    slskdRepairNeedsRestart: "Collegamento riparato. Riavvia slskd per completare la configurazione.",
    ...
    backupNow: "Crea backup…",
    backupSavePrompt: "Salva il backup di Cratory",
    backupDone: (path: string, mb: string) => `Backup scritto in ${path} (${mb} MB).`,
    backupNote: "Il backup include le credenziali dei servizi. Conserva il file in un posto sicuro.",
    ...
    statusNotConfigured: "Da configurare",
    ...
    servicesMeta: {
      spotify: {
        detail: "Importa playlist e brani salvati.",
      },
      anthropic: {
        detail: "Abilita Set Agent e i suggerimenti AI in Organize.",
      },
      discogs: {
        detail: "Cerca dischi e completa le informazioni dei brani.",
      },
      musicbrainz: {
        detail: "Trova artista, titolo e dati delle pubblicazioni.",
      },
      acoustid: {
        detail: "Riconosce i brani a partire dall’audio.",
      },
      slskd: {
        detail: "Cerca e scarica musica dalla rete Soulseek.",
      },
      soundcloud: {
        detail: "Importa i tuoi Mi piace e scarica i brani.",
      },
    } as Record<string, { detail: string }>,
    reconnectButton: "Ricollega",
    connectButton: "Collega",
    collapseKeys: "Chiudi",
    fieldLibraryRoot: "Cartella della musica",
    fieldArchiveRoot: "Cartella di archivio",
    fieldDownloadsDir: "Cartella dei download",
    fieldSlskdUrl: "Indirizzo di slskd",
    fieldSlskdConfig: "File di configurazione di slskd",
    ...
    shareLibraryHint: "Gli altri utenti potranno vedere e scaricare i file della tua libreria.",
    shareOnRescan: "Condivisione attiva. L’elenco dei file condivisi è stato aggiornato.",
    shareOnPending: "Preferenza salvata. La condivisione sarà attiva al prossimo avvio di slskd.",
    shareOff: "Condivisione disattivata.",
    downloadSlotsLabel: "Download simultanei",
    downloadSlotsHint: "Quanti brani scaricare insieme, da 1 a 10.",
    downloadSlotsInvalid: "Valore non valido (serve un numero tra 1 e 10): ripristinato quello in vigore.",
    soundcloudYtdlpUnavailable: "Manca yt-dlp, necessario per importare da SoundCloud.",
    usernameLabel: "Nome utente SoundCloud",
    ...
    soulseekUnreachable: "Il servizio Soulseek non è raggiungibile",
    soulseekConnect: "Connetti",
    soulseekDisconnect: "Disconnetti",
    canonicalLibraryTitle: "Scansione della libreria",
    canonicalLibraryBody: "Aggiorna l’elenco dei brani dopo aver aggiunto o spostato file.",
    indexFailedFallback: "Scansione non riuscita",
    indexingLabel: "In corso…",
    indexNowButton: "Scansiona ora",
    ...
    discoveryDiscogs: "Mostra Discogs in Discovery",
    discoveryDiscogsHint: "Aggiunge Discogs alle fonti disponibili per la ricerca.",
  },
  setup: {
  ...
  dashboard: {
    ...
    stageOrganizeSub: "Organizza le tracce che possiedi e i loro tag",
    stageAnalyze: "Analizza",
    stageAnalyzeSub: "Analizza BPM & KEY",
    stagePlay: "Suona",
    stagePlaySub: "pronte per un set",
    statsLink: "Statistiche",
    djPlayRandom: "Suona una traccia a caso",
    spectrumLabel: "spettro",
  },
  stats: {
    title: "Statistiche",
    bpm: "Istogramma BPM",
    keys: "Tonalità",
    keysWheel: "ruota Camelot",
    keysMinor: "A · minore",
    keysMajor: "B · maggiore",
    keyTracks: (camelot: string, n: number) =>
      n === 1 ? `${camelot} · 1 traccia` : `${camelot} · ${n} tracce`,
    genres: "Generi",
    genresTail: (n: number) => `+${n} nella coda`,
    labels: "Label",
    labelsOf: (shown: number, total: number) => `prime ${shown} di ${total}`,
    energy: "Energia",
    energyFlat: "distribuzione piatta",
    sources: "Fonti",
    coverage: "Copertura",
    coverageReady: "Pronte per un set",
    coverageMissing: (n: number) =>
      n === 1 ? "1 senza BPM o tonalità" : `${n} senza BPM o tonalità`,
    figTracks: "Tracce",
    figOwned: "Possedute",
    figPlaylists: "Playlist",
    figGenres: "Generi distinti",
    figLabels: "Etichette distinte",
    figBpmRange: "Range BPM",
  },
  analysis: {
    pageTitle: "Analisi",
  ...
  wishlist: {
    ...
    emptyFilteredBody: "Cambia stato, playlist o ricerca.",
  ...
  sets: {
    ...
    emptyBody: "Usa «Prepara un set» per cominciarne uno a mano.",
    legacyBadge: "vecchio formato",
    legacyHint: "Creato dal vecchio generatore: si può solo esportare o eliminare.",
    algoBadge: "algo",
    ...
    manual: {
      ...
      selectRowLabel: "Seleziona la riga",
      sequenceUnnamed: "senza nome",
      sequenceMeta: (n: number) => (n === 1 ? "1 traccia" : `${n} tracce`),
      renameSequenceTitle: "Rinomina la sequenza",
      sequenceNamePlaceholder: "Nome della sequenza",
      splitSequenceTitle: "Separa la sequenza",
      toBenchTitle: "Sposta sul banco",
      benchTitle: "Banco",
      benchEmpty: "Niente sul banco. Raggruppa delle righe e spostale qui per provarle fuori dal percorso.",
      benchToPathTitle: "Rimetti nel percorso",
      moveSequenceUpTitle: "Sposta la sequenza su",
      moveSequenceDownTitle: "Sposta la sequenza giù",
      playBpmLabel: "La suono a",
      playBpmHint: "Vuoto = al tempo della traccia.",
      transitionInTitle: "Dal brano precedente",
      transitionOutTitle: "Al brano successivo",
      ...
      durationIncompleteWhy: (rows: number, gaps: number) => [
        rows ? (rows === 1 ? "1 traccia senza durata" : `${rows} tracce senza durata`) : "",
        gaps ? (gaps === 1 ? "1 varco aperto" : `${gaps} varchi aperti`) : "",
      ].filter(Boolean).join(" · "),
      plannedSecondsLabel: "Quanto la tengo",
      plannedSecondsHint: "Vuoto = la durata del file.",
      exportButton: "Esporta",
      exportPreviewTitle: "Anteprima",
      exportDownloadButton: "Scarica",
      exportFormatText: "Testo",
      exportFormatCsv: "CSV",
      exportFormatMarkdown: "Markdown",
      exportFormatM3u8: "M3U8 (Rekordbox)",
      exportFormatPrep: "Scheda di preparazione",
      exportFormatReserve: "Riserve",
      fillGapTitle: "Riempi il varco",
      fillGapCountLabel: "Quante tracce",
      fillGapButton: "Riempi",
  ...
  organize: {
    ...
    settings: {
      organization: "Regole di organizzazione",
      tplNameLabel: "Nome del file",
      fieldsLabel: "Campi disponibili:",
      tplFolderLabel: "Sottocartelle",
      subfoldersLabel: "sottocartelle:",
      noSubfolders: "Lascia vuoto per salvare tutto nella cartella della musica.",
      pathPreview: "Esempio",
      previewHint: "Il percorso effettivo dipende dai dati del brano.",
      saveTemplates: "Salva regole",
      foldersNote: "Le regole saranno usate nelle prossime operazioni di Organize.",
    },
    files: {
      facetGenre: "genere…",
      facetArtist: "artista…",
  ...
  errors: {
    ...
    set_block_not_found: "Sequenza non trovata",
    set_nothing_to_undo: "Niente da annullare",
    set_nothing_to_redo: "Niente da ripetere",
    set_fill_failed: "Il generatore non è riuscito a riempire questo varco",
    set_format_not_available: "Questo formato è del set preparato a mano",
    ...
    update_check_failed: (p: Record<string, unknown>) =>
