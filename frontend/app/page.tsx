...
import {
  Music, Gauge, KeyRound, Sparkles, ListPlus, Compass, ArrowRight, ListMusic, CheckCircle2,
} from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="mb-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Action href="/set-builder" icon={<Sparkles size={18} />} title="Costruisci un set" desc="Bozza spiegata da vincoli o prompt" />
        ...
        <>
          ...
          <div className="mt-3 grid gap-3 lg:grid-cols-3">
            <Card className="p-4 lg:col-span-2">
              ...
              <Link href="/settings" className="mt-3 inline-flex items-center gap-1 text-sm text-info hover:underline">Arricchisci le feature musicali <ArrowRight size={14} /></Link>
            </Card>
            ...
            <Card className="p-4">
              ...
              <div className="mb-2 mt-4 flex items-center gap-1.5 text-xs font-medium uppercase tracking-wide text-muted"><KeyRound size={13} className="text-faint" /> Tonalità (Camelot)</div>
              <div className="flex flex-wrap gap-1">
                {Object.entries(stats.key_distribution).length === 0 && <span className="text-sm text-faint">—</span>}
