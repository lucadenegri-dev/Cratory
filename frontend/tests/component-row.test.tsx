...
/* Qui stava "ComponentRow: demone slskd", sei test sul modulo credenziali e
   sull'installa-e-avvia che questa riga faceva solo per slskd. Quel percorso
   non passa piu' di qui: vive tutto in components/slskd-row.tsx, e i test
   sono in tests/slskd-row.test.tsx — fasi, etichette di `owned`, e il
   bottone Ferma che compare solo se il demone e' nostro. */
