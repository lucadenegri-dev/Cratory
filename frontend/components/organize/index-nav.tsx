...
import { libraryStats, type LibraryStats } from "@/lib/organize/api";
  ...
  return (
    <nav className="flex h-full flex-col">
      <div className="px-4 py-4">
        <Link href="/organize/files" className="block text-sm font-semibold tracking-[0.12em] text-fg-strong">
          SORTORY
        </Link>
