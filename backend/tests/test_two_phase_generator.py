"""Il beam search: convergenza verso l'anchor, piano di genere, riserva.

Era la fase 2 del generatore di set; da quando il generatore e' sparito
(2026-09-19) il beam e' il motore di «riempi il varco», e questi test sono
la sua rete."""
