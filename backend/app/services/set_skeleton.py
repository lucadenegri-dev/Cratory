"""I parametri di carattere del beam search e la matematica degli archi.

Era la fase 1 del set generator: profili di strategia, scheletro del set,
anchor e piano di genere. Con la rimozione del generatore (2026-09-19)
restano le sole parti che il beam usa ancora — e che oggi servono a
«riempi il varco» dentro un set preparato a mano.
"""
