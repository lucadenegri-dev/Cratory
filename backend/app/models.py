...
class DjSet(Base):
    ...
    # Offset (s) a cui l'analisi si e' interrotta per errori persistenti del
    # recognizer (endpoint giu'): il set e' "done" ma parziale. None = completa.
    aborted_at_seconds: Mapped[int | None] = mapped_column(Integer)
